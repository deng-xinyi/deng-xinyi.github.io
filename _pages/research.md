...
<a href="/images/sfn16.png"><img align="right" src="/images/sfn16.png" alt="clusterless" width="50%"/></a> Decoding algorithms have been developed to study how the firing patterns of neural systems maintain dynamic representations of relevant stimuli. In each of these cases, a key assumption is that the signals have been accurately sorted into single units before the decoding algorithm is applied. Although new spike-sorting algorithms are being developed, spike sorting remains a time-consuming, difficult task; requires significant expertise and long training; suffers from many sources of errors; and likely provides biased estimates. A continuing theme from the end of my graduate research into my postdoctoral work is clusterless decoding methods, which maintain the accuracy of previous methods, but avoid the clustering problem of spike sorting entirely.
